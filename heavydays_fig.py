...
for file in files: 
       # if file.endswith("gtc40_ltc100_eq_timsum_sub.nc") or file.endswith("gtc40_ltc100_eq_timsum_sub_ensmean.nc"):
  #  if file.endswith("gtc40_ltc100_eq_timsum_sub_ensmean.nc"):  
    if file.endswith("gtc40_timsum_sub.nc"):  
            ...
            plt.savefig('/p/tmp/anjaka/Extremes/CMIP6_day/SecondaryData/figures/heavydays_' +model + '_2.png', dpi = 800,bbox_inches='tight')
            plt.show()

...
for file in files: 
    if file.endswith("gtc0.1_ltc10_eq_timsum_sub.nc") or file.endswith("gtc0.1_ltc10_eq_timsum_sub_ensmean.nc"):
    #if file.endswith("gtc0.1_ltc10_eq_timsum_sub_ensmean.nc"):            
            ...
            plt.savefig('/p/tmp/anjaka/Extremes/CMIP6_day/SecondaryData/figures/lightdays_' +model + '2.png', dpi = 800,bbox_inches='tight')
            plt.show()

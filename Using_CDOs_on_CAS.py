...
###############################################################
#    USING CDOs ON CNRM-CM6-1-HR (CENTER: CNRM-CERFACS)       #
#                   Anja Katzenberger                         #
#           anja.katzenberger@pik-potsdam.de                  #
#                       10.06.2020                            #
###############################################################

# Data directories for historical, SSP5-8.5 and Output
hdir = os.path.abspath("/p/projects/climate_data_central/CMIP/CMIP6/CMIP/NASA-GISS/GISS-E2-1-G/historical/r1i1p3f1/Amon/pr/gn/v20180827")
rdir = os.path.abspath("/p/projects/climate_data_central/CMIP/CMIP6/ScenarioMIP/NASA-GISS/GISS-E2-1-G/ssp585/r1i1p3f1/Amon/pr/gn/v20200115")
outdir = os.path.abspath("/home/anjaka")
loc_landmask = "/home/anjaka/landmasks_masks"
...
hfiles = next(os.walk(hdir))[2]
rfiles = next(os.walk(rdir))[2]
...
mask = files[index_mask] 
mask_dir = os.sep.join((loc_landmask, mask)) 
print(mask)     
...
### Cutting India 
hist_output_India = os.sep.join((outdir, '_'.join((vbl, model, "1850-2015_India.nc"))))
...
comb_output_India = os.sep.join((outdir, '_'.join((vbl, model, ssp, "1850-2100_India.nc"))))
nco_cmd_comb_India = "ncks -Od lon,67.5,98.0 -d lat,6.0,36.0 " + comb_output + " " + comb_output_India
...
comb_output_JJASmean = os.sep.join((outdir, '_'.join((vbl, model, ssp, "1850-2100_India_JJASmean.nc")))) 
...
#fldmean
comb_output_fldmean = os.sep.join((outdir, '_'.join((vbl, model, ssp,  "1850_2100_India_JJASmean_fldmean.nc"))))

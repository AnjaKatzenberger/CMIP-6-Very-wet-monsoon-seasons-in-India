...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 16 09:36:29 2022
...
for file in files: 
      #  if file.endswith("gtc0.1_timsum_sub.nc") or file.endswith("gtc0.1_timsum_sub_ensmean.nc"):
    if file.endswith("gtc0.1_timsum_sub.nc"):            
            ...
            plt.savefig('/p/tmp/anjaka/Extremes/CMIP6_day/SecondaryData/figures/wetdays_' +model + '_2.png', dpi = 800,bbox_inches='tight')
            plt.show()
